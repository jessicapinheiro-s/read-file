...
export default function Upload() {
    ...
    return (
        <main className='w-full flex-1 overflow-y-auto flex flex-col justify-center items-start px-5 md:px-60 gap-10'>
            <div className='flex flex-col justify-center gap-2 border-green-800'>
